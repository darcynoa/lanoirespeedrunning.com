...
<head>
    ...
    <meta name="description" content="If you ever wanted to speedrun L.A. Noire, this is the perfect resource for it. Explore and learn incredible tricks to complete the game as fast as possible.">

    <title>L.A. Noire Speedrunning Guide</title>

    <!-- All CSS Stuff -->
    <link rel="stylesheet" type="text/css" href="vendors/css/normalize.css"> <!-- Helps browsers render your elements consistently -->
    <link rel="stylesheet" type="text/css" href="vendors/css/2015-03-25_13-52-05__grid.css"> <!-- Helps elements be viewable in different resolutions -->
    ...
    <link rel="mask-icon" href="resources/favicons/safari-pinned-tab.svg" color="#feb400">
    <link rel="shortcut icon" href="resources/favicons/favicon.ico">
    <meta name="msapplication-TileColor" content="#feb400">
...
<body>
    ...
    <header>
        ...
        <div class="row top-nav">
            ...
            <h1>L.A. Noire Speedrunner&rsquo;s Guide</h1>
        ...
        <div class="new-post">
            ...
            <a href="blog-001-new-cop-in-town.html">
                ...
                <div class="new-post-content">
                    ...
                    <h2>The New Cop in Town</h2>
                    <p>
                        Why did I start a website dedicated to a speedrunning for a game that is notorious for being "un-speedrun-able"?
                    </p>
    ...
    <section class="section-form" id="feedback">
        ...
        <div class="row form-header">
            ...
            <h2> Feedback </h2>
            <p>Ask a question, make a suggestion, really anything. Message me through here and I will respond.</p>
            ...
            <form method="post" action="mailer.php" class="contact-form">
                ...
                <div class="row">
                    ...
                    <div class="col span-2-of-3">
                        <input type="text" name="name" id="name" placeholder="Name or username" required>
                    </div>
